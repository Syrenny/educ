...
async def test_get_messages(test_chunks_session):
    ...
    await add_message(session, user_id, file_meta.file_id, "Message 1", True, action=Action.default)
    await add_message(session, user_id, file_meta.file_id, "Message 2", False, action=Action.default)
    await add_message(session, user_id, file_meta.file_id, "Message 3", True, action=Action.default)
